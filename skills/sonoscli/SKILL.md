...
## 多平台播放（Qobuz / TIDAL / Apple Music）

### 平台優先順序（強制）
Qobuz → TIDAL → Apple Music → Spotify
...
- 此功能依賴 patch：`bash ~/.openclaw/workspace/scripts/patch-openclaw-media-player.sh`（升級 OpenClaw 後需重跑）
